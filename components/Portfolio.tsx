      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <div 
              key={index}
              className="backdrop-blur-xl bg-white/10 rounded-xl overflow-hidden border border-white/30 shadow-2xl ring-1 ring-white/20 hover:bg-white/15 hover:shadow-3xl transition-all duration-300"
            >
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.technologies.map((tech, techIndex) => (
                    <span 
                      key={techIndex}
                      className="px-2 py-1 backdrop-blur-lg bg-white/15 rounded text-xs text-white border border-white/30 shadow-md ring-1 ring-white/10"
                    >
                      {tech}
                    </span>
                  ))}
