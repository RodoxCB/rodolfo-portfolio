  ...
  return (
    <section className="relative min-h-[140vh] overflow-hidden">
      <div className="absolute inset-0 h-screen">
        ...
        <div className="absolute left-1/2 top-1/3 h-72 w-72 -translate-x-1/2 rounded-full bg-accent-primary/20 blur-3xl animate-pulseGlow" />
        <div className="absolute inset-x-0 bottom-0 h-[30vh] bg-gradient-to-b from-transparent to-bg-primary" />
      </div>

      <div className="absolute left-1/2 top-[38vh] z-10 -translate-x-1/2 -translate-y-1/2">
        <motion.div
        ...
        >
          <div className="absolute h-40 w-40 rounded-full bg-accent-primary/25 blur-3xl sm:h-48 sm:w-48" />
      ...
      <div className="absolute left-1/2 top-[78vh] z-20 -translate-x-1/2 animate-float">
        <ArrowDown className="h-6 w-6 text-accent-primary" />
      </div>
    </section>
  );
}
